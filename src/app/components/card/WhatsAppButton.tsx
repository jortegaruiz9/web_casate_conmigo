...
const WhatsAppButton: React.FC<WhatsAppButtonProps> = ({
  ...
  return (
    <button
      ...
      id="order-button"
    >
      <div className="bg-[#cd2838] text-white rounded-md h-10 w-1/4 flex items-center justify-center absolute left-1 top-[4px] group-hover:w-[152px] z-10 duration-500">
