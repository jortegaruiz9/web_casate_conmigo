...
import { matrimonioRings } from "@/app/data/matrimonioRings"; // 👈 Importamos los datos desde /data

export const rings = matrimonioRings; // 👈 Declaramos rings basado en los datos importados
