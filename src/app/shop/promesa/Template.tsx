...
import { promesaRings } from "@/app/data/promesaRings"; // 👈 Importamos los datos externos

export const rings = promesaRings; // 👈 Declaramos rings a partir de los datos importados
